...
def plantseg_binary_classes():

    return ['background', 'disease']

def plantseg_binary_palette():
    return [[120, 120, 120], [6, 230, 230]]

def docseg_binary_classes():

    return ['background', 'disease']

def docseg_binary_palette():
    return [[120, 120, 120], [6, 230, 230]]
...
def plantseg115_classes():
    """Pascal Context class names for external use."""
    return ['', 'apple black rot', 'apple mosaic virus', 'apple rust', 'apple scab', 'banana anthracnose',
...
def plantseg115_palette():
    return [[120, 120, 120], [0, 192, 64], [0, 192, 64], [0, 64, 96], [128, 192, 192],
                 ...
                 [64, 192, 96], [64, 160, 64], [64, 64, 0]][:115]
